...
<main>
    ...
    <h3 style="text-align: center; font-style: oblique;">
        ...
        <div>
            <input style="margin-left: 700px;height: 45px; text-align: center;" placeholder="Provincia" bind:value={province}/>
        </div>
        <div>
            <Button style="margin-left: 750px;height: 45px; margin-top: 20px;" color="warning" on:click={getData(province)}>Buscar</Button>
        </div>
