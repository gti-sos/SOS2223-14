...
test('get apartament occupancy surveys link', async ({ page }) => {
  ...
  test('Pruebas e2e apartment-occupancy-surveys', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Página siguiente' }).click();
    await page.getByRole('row', { name: 'Sevilla 2020 1 1 1 Borrar/actualizar dato' }).getByRole('button', { name: 'Borrar/actualizar dato' }).click();
    ...
    await page.getByRole('button', { name: 'Actualizar dato' }).click();
    await page.getByRole('button', { name: 'Borrar dato' }).click();
    await page.getByRole('button', { name: 'Volver a la página' }).click();
